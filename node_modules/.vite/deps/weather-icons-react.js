...
//#region node_modules/weather-icons-react/lib/iconContext.js
var require_iconContext = /* @__PURE__ */ __commonJSMin(((exports) => {
...
//#endregion
//#region node_modules/weather-icons-react/index.js
var import_iconBase = (/* @__PURE__ */ __commonJSMin(((exports) => {
...
var WiHurricaneWarning = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M7.8,24.6V7.45h1.13V24.6H7.8zM9.73,21.52v-6.6h8.55v6.6H9.73zM9.73,14.05v-6.6h8.55v6.6H9.73zM12.09,19.52h3.81v-2.51h-3.81V19.52zM12.09,12.05h3.81v-2.5h-3.81V12.05z" }
		}]
	})(props);
};
...
var WiMoonAltNew = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M3.74,14.44c0,2.04,0.5,3.93,1.51,5.65s2.37,3.1,4.1,4.1s3.61,1.51,5.65,1.51s3.92-0.5,5.65-1.51s3.09-2.37,4.09-4.1s1.51-3.61,1.51-5.65s-0.5-3.92-1.51-5.65s-2.37-3.09-4.09-4.09s-3.61-1.51-5.65-1.51S11.08,3.7,9.35,4.7s-3.1,2.37-4.1,4.09S3.74,12.4,3.74,14.44z" }
		}]
	})(props);
};
...
var WiMoonFirstQuarter = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M15.01,25.71c2.04,0,3.92-0.5,5.65-1.51s3.09-2.37,4.09-4.1s1.51-3.61,1.51-5.65s-0.5-3.92-1.51-5.65s-2.37-3.09-4.09-4.09s-3.61-1.51-5.65-1.51V25.71z" }
		}]
	})(props);
};
...
var WiMoonThirdQuarter = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M3.74,14.44c0,2.04,0.5,3.93,1.51,5.65s2.37,3.1,4.09,4.1s3.61,1.51,5.65,1.51V3.19c-2.04,0-3.92,0.5-5.65,1.51S6.26,7.07,5.25,8.8S3.74,12.4,3.74,14.44z" }
		}]
	})(props);
};
var WiMoonWaningCrescent1 = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M3.74,14.44c0,2.04,0.5,3.93,1.51,5.65s2.37,3.1,4.09,4.1s3.61,1.51,5.65,1.51c-1-3.14-1.49-6.9-1.49-11.26c0-3.43,0.5-7.18,1.49-11.25c-2.04,0-3.92,0.5-5.65,1.51S6.26,7.07,5.25,8.8S3.74,12.4,3.74,14.44z" }
		}]
	})(props);
};
var WiMoonWaningCrescent2 = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M3.74,14.44c0,2.04,0.5,3.93,1.51,5.65s2.37,3.1,4.1,4.1s3.61,1.51,5.65,1.51c-2.01-2.74-3.02-6.5-3.02-11.26c0-3.98,1.01-7.73,3.02-11.25c-2.04,0-3.93,0.5-5.65,1.51s-3.1,2.37-4.1,4.09S3.74,12.4,3.74,14.44z" }
		}]
	})(props);
};
var WiMoonWaningCrescent3 = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M3.74,14.44c0,2.04,0.5,3.93,1.51,5.65s2.37,3.1,4.09,4.1s3.61,1.51,5.65,1.51c-2.99-2.33-4.48-6.09-4.48-11.26c0-2.32,0.42-4.46,1.25-6.4s1.91-3.56,3.23-4.85c-2.04,0-3.92,0.5-5.65,1.51S6.26,7.07,5.25,8.8S3.74,12.4,3.74,14.44z" }
		}]
	})(props);
};
var WiMoonWaningCrescent4 = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M3.74,14.44c0,2.04,0.5,3.93,1.51,5.65s2.37,3.1,4.1,4.1s3.61,1.51,5.65,1.51c-2.07-1.01-3.59-2.45-4.56-4.33S9,17.19,9,14.44c0-2.53,0.56-4.78,1.69-6.75s2.57-3.47,4.31-4.5c-2.04,0-3.93,0.5-5.65,1.51s-3.1,2.37-4.1,4.09S3.74,12.4,3.74,14.44z" }
		}]
	})(props);
};
var WiMoonWaningCrescent5 = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M3.74,14.44c0,2.04,0.5,3.93,1.51,5.65s2.37,3.1,4.09,4.1s3.61,1.51,5.65,1.51c-2.59-0.79-4.48-2.13-5.69-4.02s-1.81-4.3-1.81-7.24c0-1.39,0.2-2.7,0.6-3.95c0.4-1.25,0.94-2.34,1.63-3.27s1.48-1.75,2.37-2.44s1.86-1.22,2.89-1.59c-2.04,0-3.92,0.5-5.65,1.51S6.26,7.07,5.25,8.8S3.74,12.4,3.74,14.44z" }
		}]
	})(props);
};
...
var WiMoonWaningGibbous2 = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M3.74,14.49c0,1.22,0.19,2.4,0.56,3.54s0.91,2.17,1.6,3.09s1.5,1.72,2.42,2.42s1.95,1.23,3.09,1.6s2.32,0.56,3.54,0.56c4.33-1.73,6.49-5.47,6.49-11.22c0-1.39-0.18-2.7-0.54-3.93s-0.85-2.31-1.47-3.23s-1.31-1.71-2.06-2.39s-1.56-1.23-2.42-1.66c-2.03,0-3.91,0.5-5.63,1.5S6.25,7.14,5.24,8.86S3.74,12.46,3.74,14.49z" }
		}]
	})(props);
};
var WiMoonWaningGibbous3 = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M3.74,14.49c0,1.22,0.19,2.4,0.56,3.54s0.91,2.17,1.6,3.09s1.5,1.72,2.42,2.42s1.95,1.23,3.09,1.6s2.32,0.56,3.54,0.56c3.61-2.07,5.42-5.81,5.42-11.22c0-1.31-0.15-2.56-0.45-3.74s-0.71-2.24-1.23-3.17s-1.1-1.75-1.72-2.46s-1.3-1.33-2.02-1.86c-1.52,0-2.98,0.3-4.37,0.89s-2.58,1.39-3.58,2.4s-1.8,2.2-2.39,3.59S3.74,12.96,3.74,14.49z" }
		}]
	})(props);
};
var WiMoonWaningGibbous4 = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M3.74,14.47c0,1.52,0.3,2.98,0.89,4.37s1.39,2.58,2.4,3.59s2.2,1.8,3.59,2.4s2.84,0.89,4.37,0.89c2.89-2.39,4.34-6.14,4.34-11.24c0-2.34-0.41-4.47-1.22-6.36s-1.85-3.52-3.11-4.87c-2.03,0-3.91,0.5-5.64,1.51S6.25,7.12,5.24,8.84S3.74,12.44,3.74,14.47z" }
		}]
	})(props);
};
var WiMoonWaningGibbous5 = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M3.74,14.47c0,2.03,0.5,3.91,1.51,5.63s2.37,3.09,4.09,4.09s3.6,1.51,5.63,1.51c2.17-2.75,3.25-6.5,3.25-11.24c0-3.96-1.08-7.71-3.25-11.24c-2.03,0-3.91,0.5-5.63,1.5S6.26,7.1,5.25,8.83S3.74,12.44,3.74,14.47z" }
		}]
	})(props);
};
var WiMoonWaningGibbous6 = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M3.74,14.46c0,2.04,0.5,3.92,1.51,5.65s2.37,3.09,4.09,4.09s3.61,1.51,5.65,1.51c1.44-3.08,2.15-6.83,2.15-11.25c0-3.46-0.72-7.2-2.15-11.24c-1.52,0-2.98,0.3-4.37,0.89S8.03,5.5,7.03,6.5s-1.8,2.2-2.4,3.59S3.74,12.93,3.74,14.46z" }
		}]
	})(props);
};
...
var WiMoonWaxingCrescent5 = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M14.99,25.71c2.04,0,3.93-0.5,5.65-1.51s3.1-2.37,4.1-4.1s1.51-3.61,1.51-5.65s-0.5-3.92-1.51-5.65s-2.37-3.09-4.1-4.09s-3.61-1.51-5.65-1.51c1.67,2.9,2.5,6.65,2.5,11.25c0,2.33-0.17,4.43-0.52,6.3S15.97,24.26,14.99,25.71z" }
		}]
	})(props);
};
...
var WiMoonWaxingGibbous1 = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M13.93,14.44c-0.02,4.53,0.33,8.29,1.04,11.27c2.04,0.01,3.93-0.49,5.65-1.49s3.1-2.36,4.11-4.08s1.52-3.61,1.53-5.65c0.01-2.04-0.49-3.93-1.49-5.65c-1-1.73-2.36-3.1-4.08-4.11s-3.6-1.52-5.64-1.53C14.32,6.91,13.94,10.66,13.93,14.44z" }
		}]
	})(props);
};
var WiMoonWaxingGibbous2 = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M12.85,14.44c0,4.77,0.71,8.52,2.14,11.26c2.04,0,3.93-0.5,5.65-1.51s3.1-2.37,4.1-4.1s1.51-3.61,1.51-5.65s-0.5-3.92-1.51-5.65s-2.37-3.09-4.1-4.09s-3.61-1.51-5.65-1.51C13.57,6.61,12.85,10.36,12.85,14.44z" }
		}]
	})(props);
};
var WiMoonWaxingGibbous3 = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M11.8,14.43c0,2.39,0.24,4.52,0.71,6.39s1.31,3.5,2.51,4.89c1.52,0,2.98-0.3,4.37-0.89s2.59-1.4,3.6-2.4s1.81-2.2,2.4-3.6s0.89-2.85,0.89-4.39s-0.3-2.99-0.89-4.38s-1.4-2.58-2.4-3.59s-2.2-1.81-3.6-2.4s-2.85-0.89-4.37-0.89c-1.02,1.46-1.81,3.16-2.37,5.13S11.8,12.3,11.8,14.43z" }
		}]
	})(props);
};
var WiMoonWaxingGibbous4 = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M10.73,14.43c0,1.19,0.07,2.29,0.2,3.3s0.35,2,0.67,2.99s0.76,1.9,1.33,2.75s1.27,1.59,2.09,2.25c1.53,0,2.99-0.3,4.38-0.89s2.58-1.4,3.59-2.4s1.81-2.2,2.4-3.6s0.89-2.85,0.89-4.39c0-2.04-0.5-3.93-1.51-5.65s-2.37-3.1-4.1-4.1s-3.61-1.51-5.65-1.51c-1.35,1.3-2.4,2.94-3.16,4.93S10.73,12.19,10.73,14.43z" }
		}]
	})(props);
};
...
var WiNA = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M6.87,18.23h1.94v-3.64h0.02l2.05,3.64h1.99v-6.66h-1.94v3.55h-0.02l-1.94-3.55h-2.1V18.23zM13.39,18.38h1.43l2.61-6.97h-1.42L13.39,18.38zM16.26,18.23h2.07l0.29-0.95h2.12l0.28,0.95h2.13l-2.43-6.66h-2.01L16.26,18.23zM19.07,15.84l0.64-2.04h0.03l0.6,2.04H19.07z" }
		}]
	})(props);
};
...
var WiStormWarning = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M9.76,24.6V7.45h1.13V24.6H9.76zM11.7,14.05v-6.6h8.55v6.6H11.7zM14.06,12.05h3.81v-2.5h-3.81V12.05z" }
		}]
	})(props);
};
...
var WiThermometerExterior = function(props) {
	return (0, import_iconBase.GenIcon)({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M9.91,19.56c0-0.85,0.2-1.64,0.59-2.38s0.94-1.35,1.65-1.84V5.42c0-0.8,0.27-1.48,0.82-2.03S14.2,2.55,15,2.55c0.81,0,1.49,0.28,2.04,0.83c0.55,0.56,0.83,1.23,0.83,2.03v9.92c0.71,0.49,1.25,1.11,1.64,1.84s0.58,1.53,0.58,2.38c0,0.92-0.23,1.78-0.68,2.56s-1.07,1.4-1.85,1.85s-1.63,0.68-2.56,0.68c-0.92,0-1.77-0.23-2.55-0.68s-1.4-1.07-1.86-1.85S9.91,20.48,9.91,19.56zM11.67,19.56c0,0.93,0.33,1.73,0.98,2.39c0.65,0.66,1.44,0.99,2.36,0.99c0.93,0,1.73-0.33,2.4-1s1.01-1.46,1.01-2.37c0-0.62-0.16-1.2-0.48-1.73c-0.32-0.53-0.76-0.94-1.32-1.23l-0.28-0.14c-0.1-0.04-0.15-0.14-0.15-0.29V5.42c0-0.32-0.11-0.59-0.34-0.81C15.62,4.4,15.34,4.29,15,4.29c-0.32,0-0.6,0.11-0.83,0.32c-0.23,0.21-0.34,0.48-0.34,0.81v10.74c0,0.15-0.05,0.25-0.14,0.29l-0.27,0.14c-0.55,0.29-0.98,0.7-1.29,1.23C11.82,18.35,11.67,18.92,11.67,19.56z" }
		}]
	})(props);
};
